# MESA: Bridging Efficiency and Utility in Personalized Federated Learning via Zero-Cost Envelope Geometry


This repository does not only implement MESA, Oort, PoC, pFedMe but also FedAvg, and Per-FedAvg algorithms.
